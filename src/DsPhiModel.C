...
void DsPhiModel::DefineModel()
{
  ...
  for(std::vector<std::string>::iterator a=magnetList.begin();a!=magnetList.end();a++){
    for(std::vector<std::string>::iterator c=chargeList.begin();c!=chargeList.end();c++){
      ...
      yield_dsd0[Ds2KKPi][*c][*a] =   new RooRealVar(Form("yield_dsd0_Ds2KKPi_%s_%s",(*c).c_str(),(*a).c_str()),   "Yield D_{s}D^{0} (KK#pi)", 1210, 0, 3000);
      yield_dsd0[Ds2PiPiPi][*c][*a] = new RooRealVar(Form("yield_dsd0_Ds2PiPiPi_%s_%s",(*c).c_str(),(*a).c_str()), "Yield D_{s}D^{0} (#pi#pi#pi)", 330, 0, 1500);
      yield_dsd0[Ds2KPiPi][*c][*a] =  new RooRealVar(Form("yield_dsd0_Ds2KPiPi_%s_%s",(*c).c_str(),(*a).c_str()),  "Yield D_{s}D^{0} (K#pi#pi)", 120, 0, 1000);
...
//HORNS:
      yield_dsd0st[Ds2KKPi][*c][*a] =   new RooFormulaVar(Form("yield_dsd0st_Ds2KKPi_%s_%s",(*c).c_str(),(*a).c_str()),   "Yield D_{s}D^{0}^{*} (KK#pi)", "@0*@1", RooArgList(*frac[Ds2KKPi][*c][*a], *PR_total_yield[Ds2KKPi][*c][*a]) );
      yield_dsd0st[Ds2PiPiPi][*c][*a] = new RooFormulaVar(Form("yield_dsd0st_Ds2PiPiPi_%s_%s",(*c).c_str(),(*a).c_str()), "Yield D_{s}D^{0}^{*} (#pi#pi#pi)", "@0*@1", RooArgList(*frac[Ds2PiPiPi][*c][*a], *PR_total_yield[Ds2PiPiPi][*c][*a]) );
      yield_dsd0st[Ds2KPiPi][*c][*a] =  new RooFormulaVar(Form("yield_dsd0st_Ds2KPiPi_%s_%s",(*c).c_str(),(*a).c_str()),  "Yield D_{s}D^{0}^{*} (K#pi#pi)", "@0*@1", RooArgList(*frac[Ds2KPiPi][*c][*a], *PR_total_yield[Ds2KPiPi][*c][*a]) );
//HILL:
      yield_dsstd0[Ds2KKPi][*c][*a] =   new RooFormulaVar(Form("yield_dsstd0_Ds2KKPi_%s_%s",(*c).c_str(),(*a).c_str()),   "Yield D_{s}^{*}D^{0} (KK#pi)", "(1-@0)*@1", RooArgList(*frac[Ds2KKPi][*c][*a], *PR_total_yield[Ds2KKPi][*c][*a]) );
      yield_dsstd0[Ds2PiPiPi][*c][*a] = new RooFormulaVar(Form("yield_dsstd0_Ds2PiPiPi_%s_%s",(*c).c_str(),(*a).c_str()), "Yield D_{s}^{*}D^{0} (#pi#pi#pi)", "(1-@0)*@1", RooArgList(*frac[Ds2PiPiPi][*c][*a], *PR_total_yield[Ds2PiPiPi][*c][*a]) );
      yield_dsstd0[Ds2KPiPi][*c][*a] =  new RooFormulaVar(Form("yield_dsstd0_Ds2KPiPi_%s_%s",(*c).c_str(),(*a).c_str()),  "Yield D_{s}^{*}D^{0} (K#pi#pi)", "(1-@0)*@1", RooArgList(*frac[Ds2KPiPi][*c][*a], *PR_total_yield[Ds2KPiPi][*c][*a]) );
...
// -------------------------------------------------------------------------
  ...
  // --------- Signal width ---------------
  for(std::vector<std::string>::iterator m=allmodeList.begin();m!=allmodeList.end();m++){
    sigma_dsd0[*m][both][both] = new RooRealVar(Form("sigma_dsd0_%s",(*m).c_str())          ,"D_{s}D^{0} sigma",14,  5,  20); //change D0 to D^0
    sigma_dsd0[*m][plus][both] = sigma_dsd0[*m][both][both];
    sigma_dsd0[*m][minus][both] = sigma_dsd0[*m][both][both];
    sigma_dsd0[*m][plus][up]   = new RooRealVar(Form("sigma_dsd0_%s_plus_up",(*m).c_str())  ,"D_{s}D^{0} sigma",14,  5,  20);
    sigma_dsd0[*m][plus][dn]   = new RooRealVar(Form("sigma_dsd0_%s_plus_dn",(*m).c_str())  ,"D_{s}D^{0} sigma",14,  5,  20);
    sigma_dsd0[*m][minus][up]  = new RooRealVar(Form("sigma_dsd0_%s_minus_up",(*m).c_str()) ,"D_{s}D^{0} sigma",14,  5,  20);//sigma_dsd0[*m][minus][up] = sigma_dsd0[*m][plus][dn];
    sigma_dsd0[*m][minus][dn]  = new RooRealVar(Form("sigma_dsd0_%s_minus_dn",(*m).c_str()) ,"D_{s}D^{0} sigma",14,  5,  20);//sigma_dsd0[*m][minus][dn] = sigma_dsd0[*m][plus][up];
  ...
  for(std::vector<std::string>::iterator m=allmodeList.begin();m!=allmodeList.end();m++){
    ncb_dsd0[*m]     = new RooRealVar(Form("ncb_dsd0_%s",(*m).c_str())     , "D_{s}D^{0} nCB",   1.000, 0,  10);
    ncb_dsd0[*m]->setConstant();
    alpha_dsd0[*m]   = new RooRealVar(Form("alphaL_dsd0_%s",(*m).c_str())  , "D_{s}D^{0} alpha", 2.2, 1, 10.0); //in Model.C it was 0.113, 0, 0.2  
  ...
  for(std::vector<std::string>::iterator m=allmodeList.begin();m!=allmodeList.end();m++){
    comb_slope_dsd0[*m] = new RooRealVar(Form("comb_slope_dsd0_%s",(*m).c_str())   ,"D_{s}D^{0} comb. slope", -0.004, -1.0, -0.0000000001);
    ...
    for(std::vector<std::string>::iterator m=modeList.begin();m!=modeList.end();m++){
      for(std::vector<std::string>::iterator a=magnetList.begin();a!=magnetList.end();a++){
        if(par->sumOverCharges){
          ...
          std::cout<<" D_{s}D^{0}: "<<y_dsd0<<"  comb: "<<y_comb<<std::endl;
          std::cout<<" D_{s}D^{*0}: "<<y_dsd0st<<" D_{s}^{*}D^{0}: "<<y_dsstd0<<std::endl;
          std::cout<<"---------------------------"<<std::endl;
        }else{
          ...
          std::cout<<(*m)<<", magnet-"<<(*a)<<" :"<<std::endl;
          std::cout<<" D_{s}D^{0} minus: "<<y_dsd0_minus<<" comb. minus: "<<y_comb_minus<<" D_{s}D^{*0} minus: "<<y_dsd0st_minus<<" D_{s}^{*}D^{0}: minus: "<<y_dsstd0_minus<<std::endl;
          std::cout<<" D_{s}D^{0} plus: "<<y_dsd0_plus<<" comb. plus: "<<y_comb_plus<<" D_{s}D^{*0} plus: "<<y_dsd0st_plus<<" D_{s}^{*}D^{0}: plus: "<<y_dsstd0_plus<<std::endl;
          std::cout<<"--------------------------------------------------"<<std::endl;
          std::cout<<" D_{s}D^{0} total: "<<y_dsd0_minus+y_dsd0_plus<<" comb. total: "<<y_comb_minus+y_comb_plus<<" D_{s}D^{*0} total: "<<y_dsd0st_minus+y_dsd0st_plus<<" D_{s}^{*}D^{0}: total: "<<y_dsstd0_minus+y_dsstd0_plus<<std::endl;

          std::cout<<" D_{s}D^{0} minus: "<<y_dsd0_minus<<" comb. minus: "<<y_comb_minus<<std::endl;
          std::cout<<" D_{s}D^{0} plus: "<<y_dsd0_plus<<" comb. plus: "<<y_comb_plus<<std::endl;
          std::cout<<"--------------------------------------------------"<<std::endl;
          std::cout<<" D_{s}D^{0} total: "<<y_dsd0_minus+y_dsd0_plus<<" comb. total: "<<y_comb_minus+y_comb_plus<<std::endl;
        }
        std::cout<<std::endl;
      }
    }
